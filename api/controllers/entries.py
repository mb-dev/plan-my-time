...
def addEntry():
    ...
    perform_update(date_str, 'add_line', {"line": line})
...
def editEntry():
    ...
    date_str = request.form['date']
    perform_update(date_str, 'edit_line', {"prev_line": prev_line, "new_line": new_line})
